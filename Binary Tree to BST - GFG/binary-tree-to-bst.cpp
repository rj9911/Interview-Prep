...
class Solution{
  public:
    ...
    // Approach -> Find inorder + sort + Find inorder throuth that vector
    ...
    {
        vector<int> v;
        inorder_tree(root, v);     // Finding inorder
        
        sort(v.begin(), v.end());  // Sorted Inorder -> BST
        int i=0;
        inorder_bst(root, v, i);   // Making tree according to sorted inorder
