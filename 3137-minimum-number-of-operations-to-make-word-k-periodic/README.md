<h2><a href="https://leetcode.com/problems/minimum-number-of-operations-to-make-word-k-periodic/">3137. Minimum Number of Operations to Make Word K-Periodic</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>You are given a string <code>word</code> of size <code>n</code>, and an integer <code>k</code> such that <code>k</code> divides <code>n</code>.</p>
...
<div id="gtx-trans" style="position: absolute; left: 107px; top: 238.5px;" bis_skin_checked="1">
<div class="gtx-trans-icon" bis_skin_checked="1">&nbsp;</div>
</div>
