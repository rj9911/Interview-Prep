<h2><a href="https://leetcode.com/problems/append-k-integers-with-minimal-sum/">2195. Append K Integers With Minimal Sum</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>You are given an integer array <code>nums</code> and an integer <code>k</code>. Append <code>k</code> <strong>unique positive</strong> integers that do <strong>not</strong> appear in <code>nums</code> to <code>nums</code> such that the resulting total sum is <strong>minimum</strong>.</p>
